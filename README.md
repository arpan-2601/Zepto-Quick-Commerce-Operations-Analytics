...
Executive Summary	Overall KPIs	6 KPI cards, donut chart, revenue bar, delivery trend
Delivery Performance	Speed & efficiency	Histogram, scatter plot, gauge, heat-map matrix
Revenue & Orders	Revenue breakdown	Stacked bar, dual-axis chart, treemap, ribbon chart
Customer Experience	Satisfaction & surge	Dual gauges, scatter, surge analysis, cancellation trends
DAX Measures (17+)
Total Revenue, Avg Order Value, Revenue per Order
Avg Delivery Time, Late Delivery Rate %, Avg Delivery Efficiency
Cancellation Rate %, Surge Rate %, Avg Surge Order Value
Avg Customer Rating, Avg Rider Rating, Combined CX Score
Revenue Rank by Warehouse, % High Value Orders
